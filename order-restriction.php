 ...
 * Description: Restrict order to specific amount and create notice for this amount.
 * Version: 1.0.0
 ...
 */
 ...
 //  include css and js for user
  function ortn_enqueue_style() {
    ...
    wp_enqueue_style( 'ortn-user-font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css' );
  ...
  function ortn_enqueue_style_admin($hook) {
    ...
    // enqueue css
    if ( $current_page != 'ortn') {
      return;
    }
    wp_enqueue_style( 'ortn-admin-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css' );
    wp_enqueue_style( 'ortn-admin-font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css' );
    ...
    wp_enqueue_script( 'ortn-admin-bootstrap-js', 'https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.4/dist/umd/popper.min.js' );
    wp_enqueue_script( 'ortn-admin-bootstrap-js-bundle', 'https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js' );
    wp_enqueue_script('ortn-admin-font-awesome-js', plugin_dir_url(__FILE__) . 'js/admin-panel/fontawesome.min.js', array(), '6.5.2', true );
      ...
      <div class="row">
          ...
          <div class="col-8">
            ...
            <form action="options.php" method="post">
                ...
                <!-- notice icon -->
                <div class="form-group orth-icon bg-light p-3"> 
                  <div class="row">
                      <div class="col-6">
 ...
 function orth_plugin_redirect(){
   if(get_option('orth_plugin_do_active', false)){
     ...
     if(!isset($_GET['active-multi'])){
       wp_safe_redirect( admin_url('admin.php?page=ortn') );
       exit;
     }
   }
 }
